...
-- the move is invalid
movePiece :: Board -> Int -> Location -> Location -> Maybe Board
...
move :: Board -> Timestamp -> Location -> Location -> Maybe Board

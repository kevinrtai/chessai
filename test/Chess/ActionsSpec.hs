...
spec = do
  ...
  describe "move" $ do
    it  "moves pawn from (1, 1) to (8, 2)" $ do
        let starting = Map.fromList [((1, 1), Piece Pawn Black 0)];
        let expected = Map.fromList [((8, 2), Piece Pawn Black 0)];
        let result   = move starting 0 (1, 1) (8, 2);
        case result of
    ...
    it  "moves pawn from (1, 1) to (3, 4) without touching other pieces" $ do
        let starting = Map.fromList [((1, 1), Piece Pawn Black 0),
                                     ((1, 2), Piece Pawn White 0)];
        let expected = Map.fromList [((3, 4), Piece Pawn Black 0),
                                     ((1, 2), Piece Pawn White 0)];
        let result = move starting 0 (1, 1) (3, 4);
        case result of
          Just a -> a `shouldBe` expected
          Nothing -> assertFailure "got Nothing from move"
  ...
  describe "moveKing" $ do
    it  "moves King north from (4, 4) to (4, 5)" $ do
        ...
        let expected = Map.fromList [((4, 5), Piece King Black 0)];
        let result = moveKing starting 0 (4, 4) (4, 5); 
        case result of
          Just a -> a `shouldBe` expected
          Nothing -> assertFailure "got Nothing from moveKing"
    it  "moves King northeast from (4, 4) to (5, 5)" $ do
        let starting = Map.fromList [((4, 4), Piece King Black 0)];
        let expected = Map.fromList [((5, 5), Piece King Black 0)];
        let result = moveKing starting 0 (4, 4) (5, 5); 
        case result of
          Just a -> a `shouldBe` expected
          Nothing -> assertFailure "got Nothing from moveKing"
    it  "moves King east from (4, 4) to (5, 4)" $ do
        let starting = Map.fromList [((4, 4), Piece King Black 0)];
        let expected = Map.fromList [((5, 4), Piece King Black 0)];
    ...
    it  "moves King southeast from (4, 4) to (5, 3)" $ do
        let starting = Map.fromList [((4, 4), Piece King Black 0)];
        let expected = Map.fromList [((5, 3), Piece King Black 0)];
    ...
    it "moves King south from (4, 4) to (4, 3)" $ do
        let starting = Map.fromList [((4, 4), Piece King Black 0)];
        let expected = Map.fromList [((4, 3), Piece King Black 0)];
    ...
    it  "moves King southwest from (4, 4) to (3, 3)" $ do
        let starting = Map.fromList [((4, 4), Piece King Black 0)];
        let expected = Map.fromList [((3, 3), Piece King Black 0)];
    ...
    it  "moves King west from (4, 4) to (3, 4)" $ do
        let starting = Map.fromList [((4, 4), Piece King Black 0)];
        let expected = Map.fromList [((3, 4), Piece King Black 0)];
    ...
    it  "moves King northwest from (4, 4) to (3, 5)" $ do
        let starting = Map.fromList [((4, 4), Piece King Black 0)];
        let expected = Map.fromList [((3, 5), Piece King Black 0)];
